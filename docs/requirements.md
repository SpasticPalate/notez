...
**Target Deployment:** Docker container hosted on private server, accessible via Cloudflare tunnel at notez.example.com
**Version:** 1.0.0
...
NODE_ENV=production
PORT=3000
BASE_URL=https://notez.example.com
...
- Tunnel endpoint: notez.example.com
